...
import { CardGrid, Container, Footer, Header } from '@/_components/layout';
import { Light } from '@/_components/decorations';
        ...
        >
          ...
          <Container>
            <div className="my-24 w-full text-center">
              <motion.h1
                className="mb-24 bg-gradient-to-b from-[#ff9662] to-[#FF50B9] bg-clip-text
