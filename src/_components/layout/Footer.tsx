      ...
      >
        <div className="mb-20 md:mb-0">
          <motion.h1
            ...
            className="mb-7 bg-gradient-to-b from-[#ff9662] to-[#FF50B9] bg-clip-text
        font-radwave text-4xl text-transparent md:text-6xl"
          ...
          <Link
            ...
            className="mb-8 -ml-2 inline-flex items-center rounded-xl p-2
              transition-colors hover:text-neutral-100 hover:bg-neutral-100/5
          ...
          <div className="flex text-3xl">
            {settings.socials.map(({ icon, link }) => (
              <Link
                ...
                target="_blank"
                href={link}
                className="mr-4 -ml-2 block rounded-lg p-2 text-xl font-bold
                  transition-colors ease-out text-white
                  hover:text-neutral-100 hover:bg-neutral-200/10
                  active:bg-transparent active:text-neutral-600"
              >
                {icon}
              </Link>
              ...
              <motion.li key={link} {...staggerProps.children}>
                <Link
                  className="-ml-2 block rounded-lg p-2 font-bold transition-colors
                    ease-out text-neutral-600 hover:text-neutral-100 hover:bg-neutral-200/10
                    active:bg-transparent active:text-neutral-600 md:-mr-2"
                  href={link}
                  style={{
